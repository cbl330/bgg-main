<?php
/**
 * Template Name: Product Category - Gold
 *
...
get_header(); 
    ...
    // Check for selected categories in the menu
    $selected_secondary_category = isset( $_GET['secondary_category'] ) ? sanitize_text_field( $_GET['secondary_category'] ) : '';
    $selected_tertiary_category = isset( $_GET['tertiary_category'] ) ? sanitize_text_field( $_GET['tertiary_category'] ) : '';
?>
                ...
                <div class="container">
                    <div class="row products-block-row products-desktop">
                        ...
                        <?php
                            ...
                            // Add Secondary Category to the query
                            if ( ! empty( $selected_secondary_category ) ) {
                            ...
                            // Add Tertiary Category to the query
                            if ( ! empty( $selected_tertiary_category ) ) {
                                $products_args_desktop['tax_query'][] = array(
                                    'taxonomy' => 'product_categories',
                                    'field'    => 'slug',
